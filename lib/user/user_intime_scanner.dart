...
class _AttendanceScannerState extends State<AttendanceScanner> {
  ...
  Future<void> _checkAttendanceStatus() async {
    ...
    if (storedDate == today) {
      ...
      // 🧠 Clear latitude and longitude from SharedPreferences
      ...
      setState(() {
        ...
        lastScanDate = null;
        // 🧠 Reset latitude and longitude state
        lastLatitude = null;
        lastLongitude = null;
      });
    }
        ...
        actions: [
          IconButton(
            ...
            onPressed: isLoading
                ...
                : () {
                    Share.share(
                        'Attendance: In: $scannedInTime, Out: $scannedOutTime, Location: $scannedLocation, Device: $mobileModel, Lat: $lastLatitude, Lon: $lastLongitude');
                  },
          ),
        ],
      ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          // 🧠 Display latitude and longitude in UI
                          if (lastLatitude != null &&
                              lastLongitude != null) ...[
                            const SizedBox(height: 10),
                            Text(
                              'Coordinates: Lat: $lastLatitude, Lon: $lastLongitude',
                              style: const TextStyle(fontSize: 14),
                            ),
                          ],
                        ],
  ...
  Future<String> _getReadableLocation() async {
    try {
      ...
      print(
          "📍 Saved to SharedPreferences: Lat=${position.latitude}, Lon=${position.longitude}");
