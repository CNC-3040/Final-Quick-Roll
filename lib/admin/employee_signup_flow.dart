...
// class EmployeeCompanyIdScreen extends StatelessWidget {
//   const EmployeeCompanyIdScreen({Key? key}) : super(key: key);
...
//               right: 0,
//               child: Column(
//                 crossAxisAlignment: CrossAxisAlignment.center, // Fixed syntax
//                 children: [
//                   Text(
//                     "Company",
//                     style: GoogleFonts.poppins(
...
//               child: RoundedTextBox(
//                 hint: "Company ID",
//                 initialValue: employeeModel.companyId,
//                 errorText: employeeModel.companyIdError,
//                 onChanged: (value) {
//                   employeeModel.setValue('companyId', value);
//                   employeeModel.validateCompanyId();
//                 },
//               ),
//             ),
//             Positioned(
...
//               child: GestureDetector(
//                 onTap: () {
//                   if (employeeModel.validateCompanyId()) {
//                     employeeModel.setScreenIndex(1);
//                     Navigator.push(
//                       context,
//                       NoAnimationPageRoute(
...
//               ListTile(
//                 leading:
//                     const Icon(Icons.camera_alt, color: AppColors.deepTeal),
//                 title: Text(
//                   'Camera',
...
//                 onTap: () {
//                   Navigator.pop(context);
//                   employeeModel.pickImage(field, ImageSource.camera);
//                 },
//               ),
//               ListTile(
//                 leading:
//                     const Icon(Icons.photo_library, color: AppColors.deepTeal),
//                 title: Text(
//                   'Gallery',
//                   style: GoogleFonts.poppins(fontSize: 16),
//                 ),
//                 onTap: () {
//                   Navigator.pop(context);
//                   employeeModel.pickImage(field, ImageSource.gallery);
//                 },
//               ),
//             ],
//           ),
...
//               child: Text(
//                 'Cancel',
//                 style: GoogleFonts.poppins(color: AppColors.myTeal),
//               ),
//             ),
//           ],
//         );
...
//                   GestureDetector(
//                     onTap: () =>
//                         _showImageSourceDialog(context, 'documentImage'),
//                     child: Container(
//                       height: 60,
//                       padding: const EdgeInsets.symmetric(horizontal: 20),
//                       decoration: BoxDecoration(
...
//                   const SizedBox(height: 20),
//                   GestureDetector(
//                     onTap: () => _showImageSourceDialog(context, 'photoPath'),
//                     child: Container(
//                       height: 60,
//                       padding: const EdgeInsets.symmetric(horizontal: 20),
//                       decoration: BoxDecoration(
...
//                     employeeModel.setValue('documentImage', '');
//                     employeeModel.setValue('photoPath', '');
//                     employeeModel.setScreenIndex(8);
//                     Navigator.push(
//                       context,
//                       NoAnimationPageRoute(
//                         builder: (context) =>
...
//   @override
//   Widget build(BuildContext context) {
//     return const EmployeeCompanyIdScreen();
//   }
// }
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
